...
func (h *AuthHandler) Register(ctx *gin.Context) {
	...
	if err != nil {
		if utils.CheckErrorForWord(err, "required") {
			helpers.RespondWithError(ctx, http.StatusBadRequest, "Missing required registration fields", map[string]interface{}{
				"validation_errors": utils.GetValidationError(ErrPleaseCompleteAllFields),
				"provided_fields":   si,
			})
			return
		} else if utils.CheckErrorForWord(err, "emailvalidatior") {
			helpers.RespondWithError(ctx, http.StatusBadRequest, "Invalid email format", map[string]interface{}{
				"validation_errors": utils.GetValidationError(ErrInvalidEmail),
				"provided_email":    si.Email,
			})
			return
		}
		helpers.RespondWithError(ctx, http.StatusBadRequest, "Invalid registration data", map[string]interface{}{
	...
	if err != nil {
		if errors.Is(err, repository.ErrEmailAlreadyExits) {
			helpers.RespondWithError(ctx, http.StatusConflict, "Registration failed - Duplicate information", map[string]interface{}{
				"error": err.Error(),
				"email": si.Email,
			})
			return
		}
		helpers.RespondWithError(ctx, http.StatusInternalServerError, "Registration failed", map[string]interface{}{
			"error": err.Error(),
		})
		return
	}

	helpers.RespondWithSuccess(ctx, http.StatusCreated, "User registered successfully", map[string]interface{}{
...
func (h *AuthHandler) VerifyEmail(ctx *gin.Context) {
	...
	if err != nil {
		if utils.CheckErrorForWord(err, "required") {
			helpers.RespondWithError(ctx, http.StatusBadRequest, "Missing verification fields", map[string]interface{}{
				"validation_errors": utils.GetValidationError(ErrPleaseCompleteAllFields),
				"required_fields":   []string{"otp", "userID"},
			})
			return
		}
		helpers.RespondWithError(ctx, http.StatusBadRequest, "Invalid verification data", map[string]interface{}{
			"validation_errors": utils.GetValidationError(err),
		})
		return
	}
...
func (h *AuthHandler) Login(ctx *gin.Context) {
	...
	if err != nil {
		if utils.CheckErrorForWord(err, "required") {
			helpers.RespondWithError(ctx, http.StatusBadRequest, "Missing login credentials", map[string]interface{}{
				"validation_errors": utils.GetValidationError(ErrPleaseCompleteAllFields),
				"required_fields":   []string{"email", "password"},
			})
			return
		}
		helpers.RespondWithError(ctx, http.StatusBadRequest, "Invalid login data", map[string]interface{}{
			"validation_errors": utils.GetValidationError(err),
		})
		return
	}
	...
	if err != nil {
		if errors.Is(err, repository.ErrUserNotFound) ||
			...
			helpers.RespondWithError(ctx, http.StatusUnauthorized, "Invalid credentials", map[string]interface{}{
				"error": err.Error(),
			})
			return
		}
		helpers.RespondWithError(ctx, http.StatusInternalServerError, "Login failed", map[string]interface{}{
			"error": err.Error(),
		})
		return
	}

	helpers.RespondWithSuccess(ctx, http.StatusOK, "Login successful", map[string]interface{}{
...
func (h *AuthHandler) Authenticate(ctx *gin.Context) {
	...
	if err != nil {
		helpers.RespondWithError(ctx, http.StatusUnauthorized, "Authentication failed", map[string]interface{}{
			"error": err.Error(),
		})
		return
	}

	helpers.RespondWithSuccess(ctx, http.StatusOK, "Authentication successful", map[string]interface{}{
		"user": map[string]interface{}{
			"id":         user.ID,
			"email":      user.Email,
			"first_name": user.FirstName,
...
func (h *AuthHandler) RefreshToken(ctx *gin.Context) {
	...
	if err != nil {
		if utils.CheckErrorForWord(err, "required") {
			helpers.RespondWithError(ctx, http.StatusBadRequest, "Missing refresh token", map[string]interface{}{
				"validation_errors": utils.GetValidationError(ErrPleaseCompleteAllFields),
				"required_fields":   []string{"refresh_token"},
			})
			return
		}
		helpers.RespondWithError(ctx, http.StatusBadRequest, "Invalid request data", map[string]interface{}{
			"validation_errors": utils.GetValidationError(err),
		})
		return
	}
	...
	if err != nil {
		helpers.RespondWithError(ctx, http.StatusUnauthorized, "Token refresh failed", map[string]interface{}{
			"error": err.Error(),
		})
		return
	}

	helpers.RespondWithSuccess(ctx, http.StatusOK, "Token refreshed successfully", map[string]interface{}{
...
func (h *AuthHandler) ChangePassword(ctx *gin.Context) {
	...
	if err := ctx.ShouldBindJSON(&input); err != nil {
		helpers.RespondWithError(ctx, http.StatusBadRequest, "Invalid password change data", map[string]interface{}{
			"validation_errors": utils.GetValidationError(err),
		})
		return
	}
	...
	if err != nil {
		helpers.RespondWithError(ctx, http.StatusBadRequest, "Password change failed", map[string]interface{}{
			"error": err.Error(),
		})
		return
	}

	helpers.RespondWithSuccess(ctx, http.StatusOK, "Password changed successfully", map[string]interface{}{
		"metadata": map[string]interface{}{
			"timestamp": time.Now(),
		},
	})
...
func (h *AuthHandler) SendResetPasswordVerification(ctx *gin.Context) {
	...
	if err != nil {
		helpers.RespondWithError(ctx, http.StatusBadRequest, "Reset password verification failed", map[string]interface{}{
			"error": err.Error(),
		})
		return
	}

	helpers.RespondWithSuccess(ctx, http.StatusOK, "Reset password verification sent", map[string]interface{}{
		"token": token,
		"metadata": map[string]interface{}{
			"timestamp": time.Now(),
		},
...
func (h *AuthHandler) SubmitResetPassword(ctx *gin.Context) {
	...
	if err := ctx.ShouldBindJSON(&input); err != nil {
		helpers.RespondWithError(ctx, http.StatusBadRequest, "Invalid reset password data", map[string]interface{}{
			"validation_errors": utils.GetValidationError(err),
		})
		return
	}
	...
	if err != nil {
		helpers.RespondWithError(ctx, http.StatusBadRequest, "Reset password failed", map[string]interface{}{
			"error": err.Error(),
		})
		return
	}

	helpers.RespondWithSuccess(ctx, http.StatusOK, "Password reset successfully", map[string]interface{}{
		"metadata": map[string]interface{}{
			"timestamp": time.Now(),
		},
	})
...
func (h *AuthHandler) Logout(ctx *gin.Context) {
	...
	if err := ctx.ShouldBindJSON(&input); err != nil {
		helpers.RespondWithError(ctx, http.StatusBadRequest, "Invalid logout data", map[string]interface{}{
			"validation_errors": utils.GetValidationError(err),
		})
		return
	}
	...
	if err != nil {
		helpers.RespondWithError(ctx, http.StatusInternalServerError, "Logout failed: could not destroy refresh token", map[string]interface{}{
			"error": err.Error(),
		})
		return
	}

	helpers.RespondWithSuccess(ctx, http.StatusOK, "Logged out successfully", map[string]interface{}{
		"metadata": map[string]interface{}{
			"timestamp":     time.Now(),
